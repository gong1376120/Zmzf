...
public class GroupAdapter extends BaseAdapter {
    ...
    private List<BankNameCallBackModel.DataModel.BankNameModel> list;

    public GroupAdapter(Context context, List<BankNameCallBackModel.DataModel.BankNameModel> list) {
