...
public class SPUtils {
    ...
    public static final String URL_REGISTS = "regists";
    public static final String URL_QUESTION= "questions";
    public static final String URL_FEEINFO= "feeinfo";
    public static final String URL_QR_CODE= "qrCode";
    public static final String APP_IS_OPEM= "isopen";
