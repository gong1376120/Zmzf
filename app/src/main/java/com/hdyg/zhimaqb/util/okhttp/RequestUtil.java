package com.hdyg.zhimaqb.util.okhttp;
...
class RequestUtil {
    ...
    private void getInstance(){
        mOkHttpClient = new OkHttpClient().newBuilder().connectTimeout(10, TimeUnit.SECONDS)
                .readTimeout(30,TimeUnit.SECONDS).build();//初始化被设置超时时间
