...
public class UserLoginActivity extends BaseActivity implements UserContract.UserView {
    ...
    private void initView() {
        ...
        username = SPUtils.getString(context, "login_name");
        userpwd = SPUtils.getString(context, "userpwd");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.userlogin_btn:
                ...
                map.put("sign", sign);
                LogUtil.i("登录界面请求数据" + map.toString());
    ...
    public void onGetLoginData(String str) {
        ...
        try {
            ...
            if (loginCallBackModel.getStatus() == BaseUrlUtil.STATUS) {
                ...
                SPUtils.put(context, "login_name", username);
                SPUtils.put(context, "userpwd", userpwd);
                SPUtils.put(context, "token", loginCallBackModel.getData().getToken());
